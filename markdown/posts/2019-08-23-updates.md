...
categories: updates
description: Release announcement for Ilios 3.68.1., with a spotlight on recent improvements to search functionality.
---
...
If your school is self-hosted, and you are interested in activating search in your Ilios implemetnation, please [contact us](mailto:support@iliosproject.org), or better yet, consider [hosting with us](/hosting) and be guaranteed to always stay up to date with new features and improvements.
...
- current version: **3.68.1**
- next scheduled release: **8/30/2019**
