...
categories: release
description: Release announcement for Ilios 3.16.0.
---
...
_**Please**: take a moment to review the RFC proposal and comments at [https://github.com/ilios/ilios/issues/1531](https://github.com/ilios/ilios/issues/1531)._ If you have any thoughts in either direction, please add your comments (or send them to us out of band if you are not a github user).
