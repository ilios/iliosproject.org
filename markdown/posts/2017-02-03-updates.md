...
categories: updates
description: Release announcement for Ilios 3.26.0.
---

Today we've updated to **v3.26.0**, which implements reports for all vocabulary terms in the MyReports tool. To find out what reports are available, please visit [our reports grid](https://www.iliosproject.org/myreports.html).
