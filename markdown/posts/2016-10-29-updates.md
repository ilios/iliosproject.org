...
**AMAZON TIME**: If you are interested in hosting your Ilios instance on AWS, we now have a Ansible-deployed AWS-ready implementation of the Ilios code. Please [contact us](mailto:support@iliosproject.org?subject=AWS%20deployment%20inquiry){:target="\_blank"} for more info.
