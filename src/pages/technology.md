...
**Recommended Minimum System Requirements for Ilios 3 Installation (current as of 07/2024):**
...
- MySQL using the InnoDB database engine (_v5.5 or later required_, 5.7+ recommended)
